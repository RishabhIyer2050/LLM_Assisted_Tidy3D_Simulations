...
if __name__ == "__main__":
    ...
    # This error is generated when the port_size_mult parameter in the Simulation Setting File is too big. 
    
    custom_settings = SimulationSettingsTiny3DFdtd(port_size_mult=(100,100))
